...
Tank.FireMovable.prototype.fire  = function(){
    ...
    var bullet = new this.Bullet_(this, computedBulletPower,  this.fireDirec_, new Tank.Point(this.loc_), this.bulletSpeed_, this.fireRange_)
    Tank.center(this, bullet);
    bullet.owner_ = this;
	if(this.fireRange_ < 100) bullet.visible_ = false; //攻击距离小于100 视为近战，则不显示子弹。近战依然是发出子弹来实现攻击的。
